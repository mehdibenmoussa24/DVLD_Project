...
namespace DVLD
{
    public partial class frmListUsers : Form
    {
        ...
        private void deleteToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Are you sure you want to delete User with ID: [" + dgvUsers.CurrentRow.Cells[0].Value + "]", "Confirm Delete", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
